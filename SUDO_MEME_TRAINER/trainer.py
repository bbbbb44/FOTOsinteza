...
if __name__ == "__main__":
    ...
    potDoDatabasea="/home/besko/Desktop/FOTOsinteza-main/SUDO_MEME_TRAINER/dataset" # pot do dataseta ki ga želimo uporabit.
    ...
    model.add(layers.Conv2D(16, 3, activation='relu', input_shape=(imgHeight, imgWidth, 3))) # Input layer, input shape je slika heightxwidth ter 3 channels(barve)
    model.add(layers.MaxPooling2D()) # Maxpooling layer ki poenostavi rezultate activation layerja
    model.add(layers.Conv2D(32, 3, activation='relu')) # Activation relu layer
    ...
    model.fit(training_images, epochs=4, validation_data=validation_images) # Poženemo model, epochs je št. ponovitev
